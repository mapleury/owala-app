import 'package:ecommerce_application/data/onboarding_data.dart';
import 'package:ecommerce_application/utils/const.dart';
import 'package:ecommerce_application/views/onboarding/components/boarding_content.dart';
          ...
          children: [
            Expanded(
              ...
              child: PageView.builder(
                ...
                onPageChanged: (value) {
                  //maksud dari kode ini adalah u memberi tahu
                  // setiap kali ada perubahan di satu objek/halaman
                  // yg ditrigger oleh interaksi pengguna
                  setState(() {
                    currentPage = value;
                  });
                },
